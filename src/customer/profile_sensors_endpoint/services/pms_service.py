        ...
        try:
            ...
            for reservation in masters_list:
                ...
                if reservation["entity"] == "pms_booker":
                    ...
                    first_lodge_Room_type = masters_list[0]["data"]["riRoomType"][
                        "name"
                    ]
                    ...
                    last_lodge_Room_type = masters_list[-1]["data"]["riRoomType"][
                        "name"
                    ]
                            ...
                            if (guest["isMain"]) and (
                                ...
                                pms_guests_history_list.append(
                                    PmsHistoryPrimaryGuest(
                                        ...
                                        nationality=master["data"]["pguest"][
                                            "coreCountry"
                                        ]["name"],
